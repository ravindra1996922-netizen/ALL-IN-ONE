...
const HomePage = () => {
  ...
  const getRandomRecipe = (() => {
    ...
    return (foods) => {
      ...
      const withVideo = foods.filter((item) => item.recipe?.videoUrl);
      ...
      <section className="py-4" style={{ background: "#f8f6f0" }}>
        <div className="container text-center">
          <h1
            ...
            style={{ color: "#3e432e", letterSpacing: "1px" }}
          >
            Invest • Shop • Eat • Learn
          </h1>
        </div>
      </section>
          ...
          <div className="row g-4">
            ...
            <div className="col-lg-4">
              <FeatureCard title="Invest with Us" image={investImg}>
                <div
                  className="position-absolute top-0 start-0 w-100 h-100 p-3 d-flex flex-column justify-content-between"
                  style={{ background: "rgba(90,98,56,0.85)" }}
                >
                  <div>
              ...
              >
                ...
                <div className="d-flex justify-content-between mb-2">
                  <div>
                    ...
                    <h6 className="mb-0">$25,400</h6>
                  </div>
                  <div>
                    <small>Total Gain:</small>
                    <h6 className="mb-0 text-success">+{gain.toFixed(1)}%</h6>
                  </div>
                </div>
